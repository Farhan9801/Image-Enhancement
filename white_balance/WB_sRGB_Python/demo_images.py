...
# input and options
in_dir = '/Users/betterhalf/Desktop/image enhancement/demo/sample_images/Motion_Deblurring/restored'
out_dir = '/Users/betterhalf/Desktop/image enhancement/demo/sample_images/white_balance/Enhanced'
if not os.path.exists(out_dir):
  os.mkdir(out_dir)
# use upgraded_model = 1 to load our new model_low_light that is upgraded with new
# training examples.
upgraded_model = 1
...
# processing
# create an instance of the WB model_low_light
